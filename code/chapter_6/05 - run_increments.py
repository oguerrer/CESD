"""Complexity Economics and Sustainable Development
   ...
   Description: performs simulations with an expenditure increment
...
for country in countries:
    ...
    # Budget   
    Bs = np.array([np.ones(years_forward)*df_expt[colYears].values.mean()]) + 100 # add 100USD per cápita
    ...
    dff.to_csv(home+"/data/chapter_6/simulation/increment/"+country+".csv", index=False)

"""Complexity Economics and Sustainable Development
   ...
   Description: runs the simulations on the substitutability of income per right
...
dff.to_csv(home+'/data/chapter_12/simulation/substitution/income/right_level.csv', index=False)

"""Complexity Economics and Sustainable Development
   ...
   Description: runs the simulations on counterfactuals with reductions
...
dff.to_csv(home+'/data/chapter_12/simulation/reduction/baseline.csv', index=False)
...
for i in persistent:
    ...
    dff = pd.DataFrame(I_hat, columns=range(Bs.shape[1]))
    dff.to_csv(home+'/data/chapter_12/simulation/reduction/program_'+str(i)+'.csv', index=False)
